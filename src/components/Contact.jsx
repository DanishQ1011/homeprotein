        ...
        <div className="mx-[18rem] mt-[150px] max-lg:mt-[130px] max-lg:mx-[1.8rem] bg-gray-100 px-10 py-6 pb-10 max-sm:px-7 rounded-lg">
            ...
            <div className='mt-6'>
                ...
                <ol className='mt-2'>
                    ...
                    <li><span className='font-semibold'>Registered Address:</span> 235, 2 FLOOR, 13 CROSS RD, 2ND STAGE, HOYSALA NAGAR, Indiranagar, Bangalore, Karnataka, PIN: 560038</li>
                    <li><span className='font-semibold'>Operational Address:</span> 235, 2 FLOOR, 13 CROSS RD, 2ND STAGE, HOYSALA NAGAR, Indiranagar, Bangalore, Karnataka, PIN: 560038</li>
