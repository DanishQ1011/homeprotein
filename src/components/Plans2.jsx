...
export default function Plan() {
  ...
  const monthylSubPrice = formatIndianNumber(
    displayConfig?.monthly?.totalSubPrice
  );
  const weeklySubPrice = formatIndianNumber(
    displayConfig?.weekly?.totalSubPrice
  );
    ...
    <section className="mt-10">
      ...
      <div className="w-full flex flex-col items-center py-10">
        <div className="flex flex-row gap-5 items-center">
          ...
          <Switch onChange={toggleSwitch} checked={isChecked} />
