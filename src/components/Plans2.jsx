    ...
    return(
        <section className="mt-10">
            <div className="flex flex-col gap-4 items-center">
                <h1 className="text-[34px] text-primary2 font-semibold">Affordable Dinner and Lunch Choices.</h1>
                <p className="text-[18px]">Savor a satisfying midday break without breaking the bank, thanks to our wallet-friendly Lunch Meal options.</p>
            </div>

            <div className="mt-10 flex gap-5 justify-center">
                <div className="p-[50px] w-[30rem] h-[31rem] rounded-md shadow-2xl">
